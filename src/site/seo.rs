...
pub fn site_description() -> &'static str {
    "Resumable Rust SSR framework. Every component is interactive by default — \
     901 B initial JS, 4.2 KiB to full interactivity, server actions, and Flow. Zero hydration."
}
